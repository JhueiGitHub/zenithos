...
CREATE TABLE "OSStyle" (
    ...
    CONSTRAINT "OSStyle_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Desktop_profileId_key" ON "Desktop"("profileId");

-- CreateIndex
CREATE INDEX "Desktop_profileId_idx" ON "Desktop"("profileId");
...
-- CreateIndex
CREATE UNIQUE INDEX "OSStyle_desktopId_key" ON "OSStyle"("desktopId");

-- CreateIndex
CREATE INDEX "OSStyle_desktopId_idx" ON "OSStyle"("desktopId");

-- CreateIndex
CREATE INDEX "OSStyle_flowId_idx" ON "OSStyle"("flowId");
...
-- CreateIndex
CREATE UNIQUE INDEX "_AssetToFlow_AB_unique" ON "_AssetToFlow"("A", "B");

-- CreateIndex
CREATE INDEX "_AssetToFlow_B_index" ON "_AssetToFlow"("B");
